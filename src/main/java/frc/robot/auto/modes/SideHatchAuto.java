...
public class SideHatchAuto extends AutoModeBase {
    ...
    protected void routine() throws AutoModeEndedException 
    {
        ...
        humanStationPathF.add(new Waypoint(humanStationTurnPos,   medOptions));
        ...
        secondTargetPathF.add(new Waypoint(target2BackupTurnPos, slowOptions));
        secondTargetPathF.add(new Waypoint(target2TurnPos,       slowOptions));
