...
public class ReversibleArcadeDriveJoystick extends JoystickControlsBase 
{
	...
	public DriveCommand getDriveCommand()
	{
		...
		double rTurn     = -mStick[0].getRawAxis(Constants.kXboxRStickXAxis);
		double lThrottle = -mStick[0].getRawAxis(Constants.kXboxLStickYAxis);
		double lTurn     = -mStick[0].getRawAxis(Constants.kXboxLStickXAxis);
